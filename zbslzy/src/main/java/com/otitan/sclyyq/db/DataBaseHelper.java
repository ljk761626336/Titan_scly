...
import com.otitan.sclyyq.dao.DaoMaster;
import com.otitan.sclyyq.dao.DaoMaster.DevOpenHelper;
import com.otitan.sclyyq.dao.DaoSession;
...
public class DataBaseHelper {
    ...
    public static Jgdc getJgdc(Context context, String kzdh, String path) {
        try {
            ...
            QueryBuilder<Jgdc> serjgdc = jgdcdao.queryBuilder().where(
                    JgdcDao.Properties.KZDH.eq(kzdh));
    ...
    public static boolean isHasJgdc(Context context, String kzdh, String path) {
        ...
        daoSession = daoMaster.newSession();
        JgdcDao jgdcdao = daoSession.getJgdcDao();
        List<Jgdc> list = jgdcdao.queryBuilder().where(JgdcDao.Properties.KZDH.eq(kzdh)).list();
        if (list.size() > 0) {
            return true;
        } else {
            return false;
